          ...
          <div class="card-body">
            ...
            <div v-if="uploadedFile" class="mt-2">
              <small class="text-muted">
                <i :class="fileTypeIcon" class="mr-1"></i>
                File type: {{ fileType }} | Size:
          ...
          <div class="card-body p-3">
            ...
            >
              <div class="text-center text-muted">
                ...
                <small>Supported formats: JPG, PNG, GIF, SVG, PDF</small>
              </div>
            </div>
          </div>
        </div>
...
function handleFileUpload(event) {
  ...
  if (file) {
    ...
    console.log(`File uploaded: ${file.name} (${detectedType})`);
  }
}
...
function addFieldToPreview(fieldToAdd) {
  ...
  for (let i = 0; i < amount; i++) {
    const newFieldInstance = {
      ...
      // For PDF files, we need to track which page the field is on
      pageNumber: fileType.value === "pdf" ? 1 : undefined,
    };
...
function handleTemplateSaved(data) {
